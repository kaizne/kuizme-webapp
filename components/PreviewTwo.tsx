...
const PreviewTwo = ({ slug, title, thumbnail }) => {
    return (
        <Link href={`/${slug}`}>
            <div className='w-40 hover:bg-gray-300 cursor-pointer rounded border shadow bg-white'>
            <div className='h-52 flex flex-col items-center'>
                <div className='w-32 mt-1 ml-1'>
                { thumbnail && <Image className='rounded' src={thumbnail} width={120} height={120} /> }
                </div>
