...
const Privacy = () => (  
  <>
    <div className='text-left px-5 py-8 md:px-20 md:py-10 font-Poppins min-h-vh'>
      ...
      that is collected and recorded by Kuizme and how we use it. 
      If you have any questions or require additional 
      information about our Privacy Policy, please do not hesitate to contact us.
      Our contact information can be found at 
      <a href='https://www.kuizme.com/contact' className='text-blue-500' 
      target='_blank'> kuizme.com/contact</a>
      .&nbsp;This Privacy Policy applies to, and is valid for, all visitors to
      <a href='https://www.kuizme.com/' className='text-blue-500'
      target='_blank'> kuizme.com</a>
      ...
      clear to you when requested.
      If you contact us directly, we may receive additional information 
      about you such as your name, email address, phone number, the 
      contents of the message and/or attachments you may send us, and 
      any other information you may choose to provide. 
      When you register for an account, we will ask you for your email address.
      We use the information we collect in various ways, including to: 
        <ul className='list-disc px-10 py-2'>
          <li>provide, operate, and maintain our website;</li>  
          <li>improve, personalize, and expand our website;</li> 
          <li>understand and analyze how you use our website;</li> 
          <li>communicate with you directly for customer service, 
      ...
      */}
      <h2 className='text-2xl md:text-4xl py-6 font-semibold'>Security</h2>
      Kuizme takes reasonable measures to help protect information about you from alteration 
